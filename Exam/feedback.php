...
<body>
  ...
  <!--header start-->
  <div class="row header" style="background: #39424e;height:64;">
    <div class="col-lg-6">
    ...
    font-family: 'Times New Roman', Times, serif ;color:white;">Seek - Q</div>
      </div>
    </div>
    <div class="col-md-2">
    </div>
    <div class="col-md-4">
      ...
      if ((!isset($_SESSION['email']))) {
        echo '<a href="#" class="pull-right sub1 btn title3" style="background:white ; line-height: 13px;" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-log-in" aria-hidden="true"></span>&nbsp;Signin</a>&nbsp;';
      } else {
        echo '<a href="logout.php?q=feedback.php" class="pull-right sub1 btn title3" style="background:white color:#39424e;line-height: 13px; " ><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Signout</a>&nbsp;';
      }
      ?>

      <a href="index.php" class="pull-right btn sub1 title3" style="background:white; color:#39424e;line-height: 13px;"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>&nbsp;Home</a>&nbsp;
    </div>
  </div>
