...
<body style="background:#eee;">
  <div class="header" style="background: #39424e;">
    <div class="navi" style="z-index: 1; position: absolute;">
    ...
    font-family: 'Times New Roman', Times, serif ;color:white;">VIVA - LINK</div>
      </div>
    </div>
    <div class=" row">
      ...
      if (!(isset($_SESSION['email']))) {
        ...
        include_once 'dbConnection.php';
        echo '<span style= "color:white" class="pull-right top title1" ><span style= "color:white" class="log1"><span style= "color:white"class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Hello,</span> <a href="account.php" class="log log1" style= "color:white">' . $name . '</a>&nbsp;|&nbsp;<a href="logout.php?q=account.php" class="log" style= "color:white"><span style= "color:white" class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Signout</button></a></span>';
      } ?>
  ...
  <!--navigation menu-->
  <nav class="navbar navbar-default title1" style="position: absolute;width:100%;">
...
<tr style="color:#39424e"><td><b>Rank</b></td><td><b>Name</b></td><td><b>KTU ID</b></td><td><b>Score</b></td></tr>';
          $c = 0;
          while ($row = mysqli_fetch_array($q)) {
            ...
            $c++;
            echo '<tr><td style="color:#99cc32"><b>' . $c . '</b></td><td>' . $name . '</td><td>' . $ktu . '</td><td>' . $s . '</td><td>';
          }
          echo '</table></div></div>';
        }
        ...
        <?php if (@$_GET['q'] == 1) {
          ...
          echo  '<div class="panel"><div class="table-responsive"><table class="table table-striped title1">
<tr><td><b>S.N.</b></td><td><b>Name</b></td><td><b>KTU ID</b></td><td><b>Email</b></td><td></td></tr>';
          $c = 1;
          while ($row = mysqli_fetch_array($result)) {
            $name = $row['name'];
            $ktu = $row['ktu'];
            ...
            echo '<tr><td>' . $c++ . '</td><td>' . $name . '</td><td>' . $ktu . '</td><td>' . $email . '</td>
